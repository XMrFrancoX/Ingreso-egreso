	...
	onMount(async () => {
		...
		if (session) {
			if (!session.user.email.endsWith("@philips.edu.ar")) {
				errorMsg =
					"Acceso denegado. Solo se permiten correos @philips.edu.ar";
...
<div class="row justify-content-center mt-3 mb-5">
	<div class="col-md-5 text-center">
		<img
			src="https://www.philips.edu.ar/favicon.png"
			alt="Philips"
			width="64"
			class="mb-3"
...
{:else}
	{#if errorMsg}
		<div class="row justify-content-center mb-3">
			<div class="col-md-5">
				<div
					class="alert alert-danger text-center shadow-sm border-0 rounded-3"
				>
					{errorMsg}
				</div>
			</div>
				...
				<div class="card glass-card p-5 text-center">
					<div class="mb-4">
						...
						<p class="text-muted small mb-0">
							Usá tu cuenta <strong>@philips.edu.ar</strong>
						</p>
					</div>
					<button
						id="btn-google-login"
